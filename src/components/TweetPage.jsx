...
//   return (
//     <div className="border-b-2 border-b-slate-600 mb-16 pb-6 flex gap-8 px-40 mt-4">
//       <div id="content" className="w-[75%] border-2 border-red-500 pt-4">
//         <div id="tweet">
//           <Tweet {...tweet} overlay={true} />
//         </div>
//         <div id="comment-section" className="pb-4 flex flex-col gap-2">
//           <h1 className="text-slate-400 pb-2 border-b-2 border-b-red-500 w-[90%] ml-7 pl-7">
//             {comments.length}{" "}
//             {comments.length !== 1 ? "Replies...." : "Reply...."}
//           </h1>
//           <div
//             id="input-post"
//             className="bg-black flex justify-between h-auto border-b-2 border-b-red-500 pb-4"
//           >
//             <div id="left" className="w-[10%] bg-black ">
//               <Link
//                 to={`/profile/${userData?.username}`}
//                 id="img"
//                 className="h-[40px] w-[40px] flex justify-center items-center mt-2.5 ml-7"
//               >
//                 <img
//                   src={
...
//               <div
//                 id="text"
//                 className="h-full bg-black flex justify-start flex-col border-b-2 border-b-red-500"
//               >
//                 <InputEmoji
...
//                         : "bg-red-500 text-black font-bold rounded-full px-2 py-2 hover:bg-black hover:text-red-500 hover:border-2 hover:border-red-500"
//                     }`}
//                   >
//                     Reply
//                   </Button>
...
//                 key={comment.$id}
//               />
//               // <Reply comment={comment} />         destructure in the Reply component
//             ))
//           ) : (
