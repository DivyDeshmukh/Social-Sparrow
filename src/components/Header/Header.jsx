...
//   return (
//     <div className="w-full h-[80px] border-b-2 border-red-600 flex justify-between items-center px-8 font-bold">
//       <Link to="/home">
...
//                   to={item.slug}
//                   className={({ isActive }) =>
//                     `hover:bg-red-600 p-2 px-3 rounded-full ${
...
//           {authStatus && (
//             <li>
//               <LogoutBtn className="hover:bg-red-600 rounded-full">
//                 Logout
//               </LogoutBtn>
//             </li>
//           )}
